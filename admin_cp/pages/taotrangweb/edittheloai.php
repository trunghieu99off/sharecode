...
if(isset($_GET['xoa'])){
  $id_get = $_GET['xoa'];
 echo '<meta http-equiv="refresh" content="1;url=/sharecode/admin_cp/pages/taotrangweb/edittheloai.php">';
 mysqli_query($connect, "DELETE FROM danhmuc WHERE id='$id_get';");
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  <?php
                  $query = mysqli_query($connect, "SELECT * FROM danhmuc ORDER BY id DESC");
                  $dem = 0;
                  while($row = mysqli_fetch_assoc($query)){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="/sharecode/admin_cp/pages/taotrangweb/edittheloai2.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-success">Edit</button></a>
