...
if(isset($_GET['xoa'])){
  ...
  mysqli_query($connect, "DELETE FROM danhsachcode WHERE id='$id_get';");
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
                  ...
                  <?php
                  $query = mysqli_query($connect, "SELECT * FROM danhsachcode ORDER BY id DESC");
                  $dem = 0;
                  while($row = mysqli_fetch_assoc($query)){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="/sharecode/admin_cp/pages/taotrangweb/editsourcecode2.php?id=<?php echo $row['id']; ?>"><button class="btn btn-sm btn-success">Edit</button></a>
